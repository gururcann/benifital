                ...
                <div class="ec-flex">
                    ...
                    <div class="align-self-center">
                        <div class="header-logo">
                            <a href="index.php"><img src="assets/images/logo/benifital_logo.png" alt="Site Logo" /><img
                                        class="dark-logo" src="assets/images/logo/benifital_logo_white.png" alt="Site Logo"
        ...
        <div class="container position-relative">
            <div class="row ">
                ...
                <div class="col">
                    <div class="header-logo">
                        <a href="index.php">
                            <img src="assets/images/logo/benifital_logo.png" alt="Site Logo" /><img
                                    class="dark-logo" src="assets/images/logo/benifital_logo_white.png" alt="Site Logo"
                                    style="display: none;" /></a>
                    </div>
                </div>
                        ...
                        <ul>
                                    ...
                                    <li class="d-flex">
                                        ...
                                        <ul class="d-block">
                                            ...
                                            <li><a href="shop-banner-right-sidebar-col-4.html">Banner right sidebar
                                                    4 column</a></li>
                                            <li><a href="products.php">Banner Full width 4 column</a>
                                            </li>
                                        </ul>
                                        <ul class="d-block">
                            ...
                            <li class="dropdown"><a href="javascript:void(0)">Products</a>
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="product_details.php">Product full width</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="shop-banner-right-sidebar-col-4.html">Banner right sidebar 4
                                            column</a></li>
                                    <li><a href="products.php">Banner Full width 4 column</a></li>
                                </ul>
                            </li>
                            <li>
